...
public class AspectV6Advice {
    ...
    @Around("hello.aop.order.aop.Pointcuts.orderAndServcice()")
    ...
    @Before("hello.aop.order.aop.Pointcuts.orderAndServcice()")
    public void doBefore(JoinPoint joinPoint) {
        log.info("[before] {}", joinPoint.getSignature());
    }

    @AfterReturning(value = "hello.aop.order.aop.Pointcuts.orderAndServcice()", returning = "result")
    ...
    @AfterThrowing(value = "hello.aop.order.aop.Pointcuts.orderAndServcice()", throwing = "ex")
    public void doThrowing(JoinPoint joinPoint, Exception ex) {
        log.info("[ex] {} message = {}", joinPoint.getSignature(), ex);
    }

    @After("hello.aop.order.aop.Pointcuts.orderAndServcice()")
